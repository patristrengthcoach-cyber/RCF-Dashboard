...
# ID del Sheet maestro (pestañas: CAD_A, CAD_B, JUV_B, SENIOR_FEM, ...)
MASTER_SHEET_ID = "1f0g87LA58B96ykmfT8s_aGlm047c_3QGyr907zckoCQ"


def _csv_url_por_hoja(sheet_id: str, sheet_name: str) -> str:
    """Carga por NOMBRE de pestaña (no requiere gid numérico)."""
...
CATEGORIAS = {
    "juvenil_a": {
        "label": "Juvenil A",
        "csv_url": "https://docs.google.com/spreadsheets/d/1fviYHi9OK10AnQJYjYIjXf2r6-URyb7ZWGJB7v3bWEA/export?format=csv&gid=1444133968",
        "cols": COLS_ESTANDAR,
    },
    "cad_a": {
        "label": "Cadete A",
        "csv_url": _csv_url_por_hoja(MASTER_SHEET_ID, "CAD_A"),
        "cols": COLS_ESTANDAR,
    },
    "cad_b": {
        "label": "Cadete B",
        "csv_url": _csv_url_por_hoja(MASTER_SHEET_ID, "CAD_B"),
        "cols": COLS_ESTANDAR,
    },
    "juv_b": {
        "label": "Juvenil B",
        "csv_url": _csv_url_por_hoja(MASTER_SHEET_ID, "JUV_B"),
        "cols": COLS_ESTANDAR,
    },
    "senior_fem": {
        "label": "Senior Femenino",
        "csv_url": _csv_url_por_hoja(MASTER_SHEET_ID, "SENIOR_FEM"),
